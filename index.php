    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(images/signup.png);">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img src="bitcoindark.png" alt="wrapkit" width="90">
                        </div>
                        ...
                        <form class="mt-4" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                    <p>Have an account?&nbsp;<a href="register.php" class="text-danger">Register</a>&nbsp;</p>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                   <a href="admin/index.php" class="text-danger">Go to Admin Panel</a>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                   <a href="index.html" class="text-danger">Go to Home</a>
                                </div>
                            </div>
                        </form>
                    </div>
