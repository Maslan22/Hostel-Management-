<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if ($result->num_rows > 0) {
            ...
            // Check if the selected room is already booked by someone of the opposite gender
            $query = "SELECT gender FROM registration WHERE roomno = ?";
            $stmt = $mysqli->prepare($query);
            ...
            if ($booked) {
                echo"<script>alert('Sorry, this room is already booked by someone of the opposite gender. Please select a different room.');</script>";
            } 
            else {
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code>Extra Ghc211 Per Semester</code></label>
                                </div>
                                <div class="custom-control custom-radio">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Total Fees Per Semester</h4>
                                    <div class="form-group">
