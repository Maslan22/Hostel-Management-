                      ...
                      <div class="table-responsive">
                                    <table id="zctb" class="table table-striped table-bordered no-wrap">
                                        ...
                                        while($row=$res->fetch_object())
                                            ...
                                            <td><b>Duration:</b></td>
                                            <td><?php echo $dr=$row->duration;?> Semester</td>
                                            ...
                                            <td><b>Fees Per Semester :</b></td>
                                            <td>GHc<?php echo $fpm=$row->feespm;?></td>
                                            ...
                                            <tr>
                                            <td colspan="6"><b>Total Fees (<?php echo ($dr).' semesters'?>) : 
...
$aid = $_SESSION['login'];
$ret = "SELECT roomno from registration where emailid=?";
$stmt = $mysqli->prepare($ret);
$stmt->bind_param('s', $aid);
$stmt->execute();
$res = $stmt->get_result();
...
// retrieve all registrations for the same room number
$ret = "SELECT * from registration where roomno=? and emailid!=?";
$stmt = $mysqli->prepare($ret);
$stmt->bind_param('ss', $roomno, $aid);
$stmt->execute();
$res = $stmt->get_result();
?>

   <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Roommates</h4>
                </div>
